  ...
  (
    ...
    return (
      <div ref={ref} className={cn("flex w-full items-end justify-center p-4", className)}>
        <Card className="m-0 w-full gap-0 border border-slate-200 p-0 shadow-lg dark:border-slate-800">
              ...
              <div className="flex items-center justify-between gap-2 p-2">
                <div className="h-8 w-[120px] md:h-10">
                  <div
                    className={cn(
                      ...
                      "bg-slate-950/5 text-slate-950/70 dark:bg-slate-50/5 dark:text-slate-50/70",
                    )}
                  >
                      ...
                      >
                        ...
                        {agentState === "disconnected" && (
                          <div className="absolute inset-0 flex items-center justify-center">
                            <span className="text-slate-950/50 text-[10px] font-medium dark:text-slate-50/50">
                              Customer Support
                            </span>
                          </div>
                        )}
                ...
                <div className="flex items-center">
                  <Button
                    ...
                    className={cn(isMuted ? "bg-slate-950/5 dark:bg-slate-50/5" : "")}
