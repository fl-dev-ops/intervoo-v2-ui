...
import { usePrediagnosticsConnectionDetails } from "#/prediagnostics/use-connection-details";
import { usePrediagnosticsPushToTalk } from "#/prediagnostics/use-push-to-talk";

export const Route = createFileRoute("/prediagnostics/session")({
  component: PreDiagnosticsSessionPage,
});

function PreDiagnosticsSessionPage() {
